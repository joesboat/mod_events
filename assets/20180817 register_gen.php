...
$WebSites = new USPSd5dbWebSites("local"); 
...
$evt = $WebSites->getEvent($event_id);
$loc = $WebSites->getLocation($evt['location_id']);
...
<div class='Section1' id='beni0'>
	...
	<tr>
		...
		<td>
			<?php echo $WebSites->getLocationName($loc,true);?>  
			<br/>
...
a registration <br />form with instructions and links to reserve a hotel room:
	...
	<tr>
		<td colspan="2">
			1.	Click on this button to initiate registration.  You may be asked to Log-in to USPSd5.org, 
			and then the 
	...
	<tr>
		...
		<td>
			<form 	method="get" 
					action="http://uspsd5.org/events/2017/20755_registration.docx">
